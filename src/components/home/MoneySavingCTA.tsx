      ...
      <div className="max-w-[1200px] w-full mx-auto px-5 md:px-8">
        <div className="flex flex-row items-stretch justify-between  border-gray-200 bg-white  hover:shadow-md transition-shadow duration-300">
          ...
          <div className="w-3/5 md:w-3/5 p-4 sm:p-8 md:p-12 flex flex-col justify-center">
            <h2 className="text-[20px] sm:text-[32px] md:text-[48px] font-medium tracking-tight text-[#111111] leading-[1.1] mb-2 sm:mb-4">
              High AC Bill?<br />
            ...
            <p className="text-[12px] sm:text-[16px] md:text-[18px] text-[#666666] mb-4 sm:mb-8 max-w-lg hidden sm:block">
              Inefficient, aging, or poorly maintained AC units can consume significantly more power. Let our experts optimize your system and lower your energy costs.
            </p>
            <p className="text-[12px] text-[#666666] mb-4 max-w-lg block sm:hidden">
              Poorly maintained AC units consume more power. Let us optimize your system.
            </p>
            <div>
              <Link 
              ...
              >
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hidden sm:block">
