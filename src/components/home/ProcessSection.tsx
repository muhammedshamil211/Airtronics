...
export default function ProcessSection() {
  return (
    <section className="py-24 bg-[#fcfcfc] border-t border-gray-100" aria-labelledby="process-heading">
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px]">
        ...
        <header className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-[#666666] text-[15px] leading-relaxed">
            We value your time and comfort. Our streamlined process ensures your HVAC problems are resolved quickly and professionally across Dubai.
          </p>
        </header>
